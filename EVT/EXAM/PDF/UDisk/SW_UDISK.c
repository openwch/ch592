...
/*********************************************************************
 * @fn      USIDK_CMD_Deal_Status
 *
 * @brief   Current command execution status
 *
 * @param   key - Primary key for disk error details
 ...
 *
 * @brief   The current command failed to execute
 *
 * @param   none
 *
 * @return  none
 ...
 *
 * @brief   Preparation before read and write sector processing
 *
 * @param   none
 *
 * @return  none
 ...
 * @fn      UDISK_In_EP_Deal
 *
 * @brief   This function is used to process IN endpoint data for USB drives
 *
 * @param   none
 *
 * @return  none
 ...
 *
 * @brief   Download endpoint processing
 *
 ...
 * @fn      UDISK_Up_CSW
 *
 * @brief   Bulk endpoint endpoint 2 upload CSW package
 *
 * @param   none
 *
 * @return  none
...
void UDISK_Down_OnePack( uint8_t *pbuf, uint16_t packlen )
{
    ...
    pdf_memcpy(UDisk_Down_Buffer + (uint32_t)UDISK_Sec_Pack_Count * UDISK_Pack_Size ,pbuf, UDISK_Pack_Size);
    UDISK_Sec_Pack_Count++;
    UDISK_Transfer_DataLen -= UDISK_Pack_Size;
